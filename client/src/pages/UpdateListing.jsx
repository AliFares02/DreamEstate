...
export default function CreateListing() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (+formData.regularPrice < +formData.discountedPrice) return setError('Discounted price cannot be more than regular price');
      setLoading(true);
      setError(false);
        ...
        <div className='flex flex-col gap-4 flex-1'>
          ...
          <div className='flex flex-wrap gap-6'>
            <div className='flex items-center gap-2'>
              <input type='number' id='bedrooms' min='1' max='10' required className='p-3 border border-gray-300 rounded-lg outline-none' onChange={handleChange} value={formData.bedrooms}/>
              <p>Beds</p>
            </div>
            <div className='flex items-center gap-2'>
              <input type='number' id='bathrooms' min='1' max='10' required className='p-3 border border-gray-300 rounded-lg outline-none' onChange={handleChange} value={formData.bathrooms}/>
              <p>Baths</p>
            </div>
            <div className='flex items-center gap-2'>
              <input type='number' id='regularPrice' min='50' max='10_000_000' required className='p-3 border border-gray-300 rounded-lg outline-none w-32' onChange={handleChange} value={formData.regularPrice}/>
            ...
            {formData.offer && (<div className='flex items-center gap-2'>
              <input type='number' id='discountedPrice' min='0' max='10_000_000' required className='p-3 border border-gray-300 rounded-lg outline-none w-32' onChange={handleChange} value={formData.discountedPrice}/>
              <div className='flex flex-col items-center'>
