  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <input type="email" placeholder="email" defaultValue={currentUser.email} id='email' className="border p-3 rounded-lg outline-none" onChange={handleChange}/>
      ...
      <button onClick={handleShowListings} className="text-green-700 w-full uppercase">show listings</button>
